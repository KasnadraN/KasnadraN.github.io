...
class InputData{
    constructor(
        ...
        this.bmpSencor_altitude = bmpSencor_altitude;
        this.bmpSencor_pressure = bmpSencor_pressure;
        this.bmpSencor_temp = bmpSencor_temp;
        this.digSensor_temp = digSensor_temp;
        this.cssSensor_temp = cssSensor_temp;
        this.cssSensor_eC02 = cssSensor_eC02;
        this.cssSensor_TVLC = cssSensor_TVLC;
        this.UV = UV;
        this.accelX = accelX;
        this.accelY = accelY;
        this.accelZ = accelZ;
...
function updateDisplay(){
    ...
    (theTime.getMinutes() < 10 ? "0" + theTime.getMinutes() : theTime.getMinutes()) + ":" + (theTime.getSeconds() < 10 ? "0" + theTime.getSeconds() 
    : theTime.getSeconds());
    //update table 
    ...
    if (timeRead >=10){
        ...
        document.getElementById("dataTable").rows["bmp_altitude"].innerHTML = 
            dataRow("bmp altitude", data[index].bmpSencor_altitude, "");
        document.getElementById("dataTable").rows["bmp_pressure"].innerHTML = 
            dataRow("bmp pressure ", data[index].bmpSencor_pressure, "");
        document.getElementById("dataTable").rows["bmp_temperature"].innerHTML = 
            dataRow("bmp temperature", data[index].bmpSencor_temp, "");
        ...
        document.getElementById("dataTable").rows["css_TVOC"].innerHTML = 
            dataRow("css TVOC", data[index].cssSensor_TVLC, "");
        ...
        document.getElementById("dataTable").rows["magnitcX"].innerHTML = 
            dataRow("magnitcX", data[index].magneticX, "");
        document.getElementById("dataTable").rows["magnitcY"].innerHTML = 
            dataRow("magnitcY", data[index].magneticY, "");
        document.getElementById("dataTable").rows["magnitcZ"].innerHTML = 
            dataRow("magnitcZ", data[index].magneticZ, "");
